...
var dialogue_dict = {
	...
	2:
		["Troll:Uhehehe! Not so fast, kaveri!", "Troll:If you wish to explore this cave, you must answer my questions fist!", "Troll:One wrong answer, and you're OUT!", "Troll:Oletko valmis? Yks, kaks...", ""]
